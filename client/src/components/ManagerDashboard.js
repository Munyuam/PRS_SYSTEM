        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <button
                className="bg-[#bd2d2d] hover:bg-[#ae2828] text-white px-4 py-2 rounded-md text-sm"
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <button
                className="bg-[#4BA66A] hover:bg-[#35754a] text-white px-4 py-2 rounded-md text-sm"
