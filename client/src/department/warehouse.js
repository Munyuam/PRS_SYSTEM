      ...
      if (response.ok) {
        ...
        if (
          ...
          setError({
            ...
            message: "You don't have Warehouse Privileges",
          });
        }
      } else {
        setError({
          status: response.status,
          message: "Access denied, you might not have Warehouse Privileges",
        });
      }
    } catch (err) {
      setError({
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="text-center">
        <p className="text-gray-600 mb-4">
          ...
          | {error?.error || "Unauthorized access. You might not have warehouse Priviledges"}
        </p>
